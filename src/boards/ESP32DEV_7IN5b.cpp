...
Renderer *ESP32DEV_7IN5b::get_renderer()
{
...
void ESP32DEV_7IN5b::stop_filesystem()
{
#ifdef USE_SPIFFS
  delete spiffs;
#else
...
ButtonControls *ESP32DEV_7IN5b::get_button_controls(xQueueHandle ui_queue)
{
